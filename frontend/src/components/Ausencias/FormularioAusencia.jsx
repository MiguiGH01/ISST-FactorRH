                    ...
                    <MDBCol col='12'>
                        ...
                        <MDBCardBody className='p-5 w-100 d-flex flex-column'>
                            ...
                            <form style={{display: "flex", flexDirection: "column", justifyContent: "center", alignContent: "center" }}>
                                ...
                                <MDBTextArea wrapperClass='mb-4 w-100' placeholder='Descripción' id='descripcion' value={descripcion} onChange={(event) => setDescripcion(event.target.value)} type='text' rows={1} style={{ resize: "none" }}/>
                                <MDBRow> Baja: <MDBCheckbox id='checkBaja' value={baj} onChange={(event) => setBaj(event.target.value)}/></MDBRow>
                                <MDBRow> Ausencia: <MDBCheckbox id='checkAusencia' value={aus}onChange={(event) => setAus(event.target.value)}/></MDBRow>
                                <MDBRow> Vacaciones: <MDBCheckbox id='checkVacaciones' value={vac}onChange={(event) => setVac(event.target.value)}/></MDBRow>
                            </form>
