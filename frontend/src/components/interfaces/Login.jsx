...
const Login = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    const usuarioCorrecto = trabajadorList.find((trabajadorItem) => {
      return (trabajadorItem.email == username && trabajadorItem.contraseña == password && trabajadorItem.rrono == true);
    });
          ...
          <MDBCol col='12'>
            ...
            <MDBCard className='bg-white my-5 mx-auto justify-content-center'>
              <MDBCardBody className='p-5 w-100 d-flex flex-column'>
                ...
                <MDBInput wrapperClass='mb-4 w-100' placeholder='Contraseña' id='formControlDefault' value={password} type='password' onChange={(event) => setPassword(event.target.value)} size="lg" />
