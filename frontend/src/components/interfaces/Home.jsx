...
const Home = (props) => {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignContent: "center", margin: "auto" }}>
            ...
            <img className="logo" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignContent: "center", margin: "auto", width: "100px", height: "100px" }} src={process.env.PUBLIC_URL + "logo_factor_rh.png"}/>
