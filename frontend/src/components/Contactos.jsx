...
const trabajadorList = props.empleados;
    ...
    return (
        <div class="contenedor-flexbox" style={{display:"flex", flexDirection:"column", justifyContent: "center", alignContent:"center", margin:"auto"}}>
            ...
            <h2 id="catálogo" style={{justifyContent: "center", alignContent: "center"}}>Contactos de nuestros trabajadores</h2>
        ...
        <div className="formulario">
         <Row className="g-2 text-center" border="success" style={{}}>
          <Col md >
          <button type="submit" className="btn btn-secondary" style={{marginBottom:"1vh"}}> Añadir trabajador</button>
                   ...
                   <Card className="flex-fill">
                       <Card.Body>
                           <div class="row">
                                ...
                                <div class="col-1">
                                <button type="submit" className="btn btn-danger" style={{marginBottom:"1vh"}}> Eliminar trabajador</button>
                                <button type="submit" className="btn btn-success" style={{marginBottom:"1vh"}}> Editar trabajador</button>
                                </div>
                            </div>
                       </Card.Body> 
                   </Card>
